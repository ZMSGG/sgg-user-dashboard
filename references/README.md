...
| Source | Resolved project-relative path | SHA-256 |
|---|---|---|
| `standards/SGG_ZERO_TO_ONE_GATEWAY_V1.md` | `../SGG　司令塔/standards/SGG_ZERO_TO_ONE_GATEWAY_V1.md` | `2b7365ece7afe570454f758a9e5cddabea78897d5b10c744149485fd07254147` |
...
| `SGG createve/canon/TERMINOLOGY.md` | `../SGG　司令塔/SGG createve/canon/TERMINOLOGY.md` | `0facd446c30a46d52f43a40c1cf9e000aa18acdb681ee2113b80e48f75d19c22` |
| `SGG createve/canon/characters.json` | `../SGG　司令塔/SGG createve/canon/characters.json` | `e48302ca5961887549085ccf218c20cea78a72f2dcb0e7a0c92fae5ce740abf5` |

Private source art is not copied into this scaffold. A canon reference proves identity, not derivative-use rights; rights evidence remains asset-specific.
