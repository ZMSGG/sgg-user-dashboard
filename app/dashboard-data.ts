...
export const games: readonly GameSummary[] = [
  {
    ...
    duration: "77",
    keyArt: "/dashboard-art/games/quest.webp",
  ...
  },
  {
    ...
    keyArt: "/dashboard-art/games/chain.webp",
  ...
  },
  {
    ...
    title: "OEDO MARKET 7",
    shortTitle: "MARKET 7",
    subtitle: "七十七ヶ月で、オエド一の投資家になれ。",
    description:
      "架空の都・穢土の七市場に上場する82社へ投資する77日シーズン。日足のローソク、指値、利確と損切り。現実の1日がゲーム内の1ヶ月として進み、いつ入っていつ降りるかで取れる幅が変わる。登場する国・企業・通貨はすべて架空で、両はゲーム内だけの通貨。",
    releaseState: "LIVE",
    releaseLabel: "配信中 · 重点タイトル",
    sourceLabel: "PRODUCTION · oedomarket.sevengodsgames.com",
    // サーバーもDBも持たず、帳簿はブラウザのlocalStorageだけ。MY SGG側から
    // 読める公開データが無いので、同期は「なし」が正しい。
    ...
    rankingUrl: null,
    guideUrl: null,
    // 2026-08-26 確認: 入口が「稽古」「本場」「試遊」の3つに分かれている。
    freePlay: { label: "稽古で遊ぶ", note: "三分の手ほどきと10倍速の試遊。どちらも待たずに始められます" },
    primaryAction: "MARKETを開く",
    nextAction: "稽古で買い方と降り方を覚える",
    nextActionMeta: "本場はシーズン制。現実の1日が1ヶ月",
    featured: true,
  },
  {
    id: "otomo-raid-7",
    title: "OTOMO RAID 7",
    shortTitle: "RAID 7",
    subtitle: "七日間、みんなで神獣を倒せ。",
    description:
      "全員が同じ1体の神獣に挑む7日間の非同期レイド。1回77秒、与えたダメージは全プレイヤー共通のボスHPから減る。リアルタイムで集まる必要はなく、好きな時間に遊んで、みんなの積み上げに自分の分を足す。",
    releaseState: "LIVE",
    releaseLabel: "配信中 · 重点タイトル",
    sourceLabel: "PRODUCTION · raid.sevengodsgames.com",
    // 共有ボスHPはサーバー側にあるが、MY SGGが読める公開APIはまだ無い。
    syncMode: "UNAVAILABLE",
    accent: "coral",
    glyph: "獣",
    ...
    rankingUrl: null,
    guideUrl: null,
    // 2026-08-26 確認: PLAY RAID の隣に PRACTICE「無制限・記録なし」がある。
    freePlay: { label: "練習で遊ぶ", note: "無制限・記録なし。ボスHPにも順位にも影響しません" },
    primaryAction: "RAIDに参加する",
    nextAction: "今日の神獣に挑む",
    nextActionMeta: "1回77秒。1日の挑戦回数に上限あり",
    featured: true,
  },
  {
    id: "otomo-oracle-7",
    ...
    genre: "DAILY LOGIC",
    duration: "7",
    keyArt: "/dashboard-art/games/oracle.webp",
  ...
  },
  {
    ...
    genre: "ACTION RPG",
    duration: "ACTION",
    keyArt: "/dashboard-art/games/taiyo.webp",
    // 旧 emberveil は403で退役。台帳の正本URLはこちら(2026-08-26 実地確認)。
    officialUrl: "https://taiyo.sevengodsgames.com/",
    rankingUrl: null,
    guideUrl: null,
    freePlay: null,
    primaryAction: "TAIYOを開く",
    nextAction: "ゲストのまま遊べる",
    nextActionMeta: "ランキング参加はDiscordログインが必要",
  },
  {
    id: "ebisu-fishing-77",
    ...
    genre: "IDLE FISHING",
    duration: "77",
    keyArt: "/dashboard-art/games/ebisu.webp",
    officialUrl: null,
    rankingUrl: null,
    guideUrl: null,
    freePlay: null,
...
export const competitions: readonly Competition[] = [
  ...
  {
    id: "market-season-ranking",
    gameId: "oedo-market-7",
    title: "資産番付",
    game: "OEDO MARKET 7",
    status: "LIVE_RANKING",
    cadence: "77-MONTH SEASON",
    rule: "七十七ヶ月終了時点の総資産",
    // 帳簿はブラウザのlocalStorageにあり、番付もゲーム内で完結する。
    integrity: "IN-GAME BOARD",
    actionLabel: "ゲームで見る",
    href: "https://oedomarket.sevengodsgames.com/",
    accent: "gold",
  },
  {
    id: "raid-season-ranking",
    gameId: "otomo-raid-7",
    title: "討伐貢献",
    game: "OTOMO RAID 7",
    status: "LIVE_RANKING",
    cadence: "7-DAY RAID",
    rule: "与ダメージの貢献と1RUNの中央値",
    integrity: "IN-GAME BOARD",
    actionLabel: "ゲームで見る",
    href: "https://raid.sevengodsgames.com/",
    accent: "coral",
  },
  {
