...
State version: `12`  
Updated: `2026-07-22T16:05:03+08:00`  
Status: `REVIEW`  
...
- ID: `CP-000012`
- Summary: Unified the project creative policy lock to SGG_CREATIVE_CHARACTER_USAGE_V2, replaced the release icon, key visual, and social card with original Image 2.0 assets, recorded asset-specific rights, provenance, hashes, crop QA, and approval evidence, and closed BLK-RIGHTS-001 without deployment.
...
4. `ACT-008` [BLOCKED] Request and record separate authority before public/shared access, a custom domain, search indexing, or added viewers and groups. — Owner: SGG project owner

## Resume exactly here

`ACT-010` — Read CP-000012; the owner rotates the bot token and client secret, configures all identity, guild, and integration values in Sites, then deploy with migration 0002 and run the section-8 gate checklist including a second-account isolation test before closing ACT-009.
